...
object ConfigConstants {
    ...
    const val kBaseUrl = "http://api-ruishang.idata.mobi"
    const val kBaseUrl1 = "http://10.0.3.2:4567"

    /**
     * 蒲公英
     */
    const val kPgyerUrl = "http://www.pgyer.com/ruishangplus"
    const val kPgyerAppId = "e22d108e745505bc9968884b0d4cbcfd"
    /**
     * 高德
     */
     ...
     * Bugly
     */
    const val BUGLY_APP_ID = "e585509883"
    /**
     * 友盟
     */
    const val kUMAppKey = "5a0e9b5bf29d982e5200017c"
    const val kUMMessageSecret = "fcc29b1a152618dcd6d4ce983eb50e57"
    /**
     * 微信分享
     */
    ...
    /**
     * 登录界面，自动登录选项：登录过的用户，下次开启应用是否免密登录
     *
     * true : 下次启动免密登录
