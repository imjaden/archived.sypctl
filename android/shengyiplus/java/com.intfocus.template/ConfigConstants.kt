...
object ConfigConstants {
     ...
     * 生意+ 正式环境
     */
    const val kAppCode = "shengyiplus"
    ...
    const val kBaseUrl = "http://shengyiplus.com"
    const val kBaseUrl1 = "http://10.0.3.2:4567"

    /**
     * 蒲公英
     */
    const val kPgyerUrl = "http://www.pgyer.com/shengyiplus-a"
    const val kPgyerAppId = "38e630134f0ca8098aeffe13d52ad5b6"
    /**
     * 高德
     */
    const val GAODE_MAP_APP_KEY = "00c191d8305d1a5a3e9a98e108f61c00"
    /**
     * Bugly
     */
    const val BUGLY_APP_ID = "de9384f4a4"
    /**
     * 友盟
     */
    const val kUMAppKey = "5705c952e0f55a391a0011cc"
    const val kUMMessageSecret = "2e4260da6ddedf736b3e67aceb4c8893"
    /**
     * 微信分享
     */
    const val kWXAppId = "wx0ad40e5c84419ce2"
    const val kWXAppSecret = "f37629d70c411400cc27809c4525d3d2"
     ...
     * false : 关闭
     */
    const val SAAS_VERIFY_BEFORE_LOGIN: Boolean = true
    /**
     * 启动页更新资源开关
     *
     * true : 启动页有资源更新 *
     ...
     * false : 不跳转 *
     */
    const val REVIEW_LAST_PAGE: Boolean = true
    /**
     * 是否保存上次退出时停留的主页签
     *
     * true : 跳转
     * false : 每次登录默认显示第一个页签 *
     */
    const val LOAD_LAST_FRAGMENT_WHEN_LAUNCH: Boolean = true
    /**
     * 是否提供扫码功能 (Kpi 概况页签)
     *
     * true : 提供 *
