...
object ConfigConstants {
    ...
    const val kBaseUrl = "http://yonghui.idata.mobi"
    const val kBaseUrl1 = "http://10.0.3.2:4567"

    /**
     * 蒲公英
     */
    const val kPgyerUrl = "http://www.pgyer.com/yhsyr"
    const val kPgyerAppId = "c586f556015342bcf89f8300ccfbebc2"
    /**
     * 高德
     */
    const val GAODE_MAP_APP_KEY = "8ca31ea2137dd24eb49a261bdd9ab844"
    /**
     * Bugly
     */
    const val BUGLY_APP_ID = "dc170466f6"
    /**
     * 友盟
     */
    const val kUMAppKey = "570f5750e0f55a54670017e1"
    const val kUMMessageSecret = "da55d55bd0b2a0bba722d541fe0454ac"
    /**
     * 微信分享
     */
    const val kWXAppId = "wx50edd59f119da198"
    const val kWXAppSecret = "e8fa301d58ff838b93268eb0e6b14ccb"
     ...
     * false : 关闭
     */
    const val ENABLE_FULL_SCREEN_UI: Boolean = false
}
