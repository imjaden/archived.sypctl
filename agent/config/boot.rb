...
unicorn_port_path    = File.join(root_path, '.config/app-port')
...
ENV['WEB_TITLE']          = File.read("#{root_path}/.config/web-title").strip rescue "生意+ 代理"
ENV['WEB_FAVICON']        = File.read("#{root_path}/.config/web-favicon").strip rescue "http://p93zhu9fx.bkt.clouddn.com/favicon-syp.png"
